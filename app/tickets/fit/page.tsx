...
export default function FITTicketsPage() {
  ...
  return (
    <AppLayout title="FIT Tickets">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
        <div>
          <h1 className="text-lg font-bold text-slate-900">FIT Tickets</h1>
          <p className="text-sm text-slate-500">Free Individual Traveler — รองรับ One-way, Round-trip, Multi-city</p>
        </div>
        <div className="flex gap-2 flex-wrap">
          <Button variant="outline" size="sm" icon={<FileDown size={14} />} onClick={() => downloadExcelTemplate('FIT')}>
            Template Excel
          </Button>
      ...
      <TicketTable filterType="FIT" filters={filters} />
    </AppLayout>
  )
}
