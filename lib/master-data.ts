...
export interface MasterAirline {
  code: string
  name: string
  nameTh?: string   // ชื่อภาษาไทยสำหรับค้นหา
}

export const MASTER_AIRLINES: MasterAirline[] = [
  // ── Thai carriers ────────────────────────────────────────────
  { code: 'TG',  name: 'Thai Airways',              nameTh: 'การบินไทย' },
  { code: 'FD',  name: 'Air Asia',                  nameTh: 'ไทยแอร์เอเชีย' },
  { code: 'DD',  name: 'Nok Air',                   nameTh: 'นกแอร์' },
  { code: 'SL',  name: 'Thai Lion Air',             nameTh: 'ไทยไลอ้อนแอร์' },
  { code: 'WE',  name: 'Thai Smile Airways',        nameTh: 'ไทยสมายล์แอร์เวย์ส' },
  { code: 'VZ',  name: 'Thai Vietjet Air',          nameTh: 'ไทยเวียดเจ็ทแอร์' },
  { code: 'XJ',  name: 'Air Asia X',                nameTh: 'แอร์เอเชียเอ็กซ์' },
  // ── East Asia ─────────────────────────────────────────────────
  { code: 'JL',  name: 'Japan Airlines',            nameTh: 'เจแปนแอร์ไลน์ส' },
  { code: 'NH',  name: 'All Nippon Airways',        nameTh: 'ออล นิปปอน แอร์เวย์ส' },
  { code: 'KE',  name: 'Korean Air',                nameTh: 'โคเรียนแอร์' },
  { code: 'OZ',  name: 'Asiana Airlines',           nameTh: 'อาเซียนาแอร์ไลน์ส' },
  { code: 'TW',  name: "T'way Air" },
  { code: 'ZE',  name: 'Eastar Jet' },
  { code: 'BX',  name: 'Air Busan' },
  { code: 'CX',  name: 'Cathay Pacific Airlines',   nameTh: 'คาเธย์แปซิฟิก' },
  ...
  { code: 'CI',  name: 'China Airlines',            nameTh: 'ไชน่าแอร์ไลน์ส' },
  { code: 'BR',  name: 'EVA Air',                   nameTh: 'อีวีเอแอร์' },
  { code: 'JX',  name: 'Starlux Airlines' },
  // ── China ─────────────────────────────────────────────────────
  { code: 'CA',  name: 'Air China',                 nameTh: 'แอร์ไชน่า' },
  { code: 'CZ',  name: 'China Southern Airlines',   nameTh: 'ไชน่าเซาเทิร์นแอร์ไลน์ส' },
  { code: 'MU',  name: 'China Eastern Airlines',    nameTh: 'ไชน่าอีสเทิร์นแอร์ไลน์ส' },
  { code: 'FM',  name: 'Shanghai Airlines' },
  { code: 'HU',  name: 'Hainan Airlines',           nameTh: 'ไห่หนานแอร์ไลน์ส' },
  ...
  { code: 'AQ',  name: '9 Air' },
  { code: '9C',  name: 'Spring Airlines',           nameTh: 'สปริงแอร์ไลน์ส' },
  ...
  // ── Southeast Asia ────────────────────────────────────────────
  { code: 'SQ',  name: 'Singapore Airlines',        nameTh: 'สิงคโปร์แอร์ไลน์ส' },
  { code: 'TR',  name: 'Scoot',                     nameTh: 'สกูต' },
  { code: 'VN',  name: 'Vietnam Airlines',          nameTh: 'เวียดนามแอร์ไลน์ส' },
  { code: 'VJ',  name: 'Vietjet Air',               nameTh: 'เวียดเจ็ทแอร์' },
  { code: 'QH',  name: 'Bamboo Airways',            nameTh: 'แบมบูแอร์เวย์ส' },
  { code: 'VU',  name: 'Vietravel Airlines' },
  { code: '9G',  name: 'Sun Phu Quoc Airways' },
  { code: 'PR',  name: 'Philippine Airlines',       nameTh: 'ฟิลิปปินส์แอร์ไลน์ส' },
  { code: '8M',  name: 'Myanmar Airways International', nameTh: 'เมียนมาร์แอร์เวย์สอินเตอร์' },
  { code: 'MM',  name: 'Peach Air',                 nameTh: 'พีชแอร์' },
  // ── South Asia ────────────────────────────────────────────────
  { code: 'AI',  name: 'Air India',                 nameTh: 'แอร์อินเดีย' },
  { code: 'SG',  name: 'SpiceJet',                  nameTh: 'สไปซ์เจ็ท' },
  { code: '6E',  name: 'IndiGo Airlines',           nameTh: 'อินดิโกแอร์ไลน์ส' },
  // ── Middle East ───────────────────────────────────────────────
  { code: 'EK',  name: 'Emirates',                  nameTh: 'เอมิเรตส์' },
  { code: 'QR',  name: 'Qatar Airways',             nameTh: 'กาตาร์แอร์เวย์ส' },
  { code: 'EY',  name: 'Etihad Airways',            nameTh: 'เอติฮัดแอร์เวย์ส' },
  { code: 'GF',  name: 'Gulf Air',                  nameTh: 'กัลฟ์แอร์' },
  { code: 'KU',  name: 'Kuwait Airways' },
  { code: 'WY',  name: 'Oman Air' },
  { code: 'SV',  name: 'Saudia Airlines',           nameTh: 'เซาเดียแอร์ไลน์ส' },
  { code: 'MS',  name: 'EgyptAir',                  nameTh: 'อียิปต์แอร์' },
  // ── Central Asia & Russia ─────────────────────────────────────
  { code: 'KC',  name: 'Air Astana' },
  { code: 'SU',  name: 'Aeroflot Russian Airlines', nameTh: 'แอโรฟลอต' },
  { code: 'OM',  name: 'MIAT Mongolian Airlines' },
  // ── Europe ────────────────────────────────────────────────────
  { code: 'TK',  name: 'Turkish Airlines',          nameTh: 'เตอร์กิชแอร์ไลน์ส' },
  { code: 'E9',  name: 'Iberojet' },
  // ── Africa ────────────────────────────────────────────────────
  { code: 'ET',  name: 'Ethiopian Airlines',        nameTh: 'เอธิโอเปียนแอร์ไลน์ส' },
  // ── Low-cost / Regional ───────────────────────────────────────
  { code: 'ZG',  name: 'Zego' },
